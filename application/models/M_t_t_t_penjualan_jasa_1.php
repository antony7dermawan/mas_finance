...
class M_t_t_t_penjualan_jasa_1 extends CI_Model {
...
public function select_inv_penjualan_jasa_1()
{
  ...
  public function select($date_penjualan_jasa_1,$type_id)
  {
    ...
    $this->db->where("T_T_T_PENJUALAN_JASA.DATE<='{$date_penjualan_jasa_1}' and T_T_T_PENJUALAN_JASA.DATE>='{$date_before}'");
