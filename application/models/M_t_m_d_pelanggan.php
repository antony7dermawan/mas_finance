...
public function select_id($id)
{
  ...
  public function select_rekap_hutang_pelanggan()
  {
    ...
    $this->db->join("(select \"T_AK_FAKTUR_PENJUALAN\".\"PELANGGAN_ID\",sum(\"PAYMENT_T\")\"SUM_PAYMENT_T\" from \"T_AK_FAKTUR_PENJUALAN\" group by \"T_AK_FAKTUR_PENJUALAN\".\"PELANGGAN_ID\") as t_sum_7", 'T_M_D_PELANGGAN.ID = t_sum_7.PELANGGAN_ID', 'left');
