...
class M_t_t_t_penjualan_jasa_2 extends CI_Model {
...
public function select_inv_penjualan_jasa_2()
{
  ...
  public function select($date_penjualan_jasa_2,$type_id)
  {
    ...
    $date_before = date('Y-m-d',(strtotime ( '-30 day' , strtotime ( $date_penjualan_jasa_2) ) ));

    $this->db->where("T_T_T_PENJUALAN_JASA.DATE<='{$date_penjualan_jasa_2}' and T_T_T_PENJUALAN_JASA.DATE>='{$date_before}'");
