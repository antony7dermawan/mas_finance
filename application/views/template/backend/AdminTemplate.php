...
<body>
    ...
    <script type="d28fd8086f5eb18f81d8672a-text/javascript" src="<?php echo base_url() ?>assets/js/sweetalert.min.js"></script>   
    <script src="<?php echo base_url() ?>assets/js/classie.js" type="d28fd8086f5eb18f81d8672a-text/javascript"></script>
    ...
    <script type="88add89075ed2b878b934720-text/javascript" src="<?php echo base_url() ?>assets/js/select2.full.min.js"></script>
    <script type="88add89075ed2b878b934720-text/javascript" src="<?php echo base_url() ?>assets/js/bootstrap-multiselect.js">
    </script>
    <script type="88add89075ed2b878b934720-text/javascript" src="<?php echo base_url() ?>assets/js/jquery.multi-select.js"></script>
    <script type="88add89075ed2b878b934720-text/javascript" src="<?php echo base_url() ?>assets/js/jquery.quicksearch.js"></script>
    <script type="88add89075ed2b878b934720-text/javascript" src="<?php echo base_url() ?>assets/js/select2-custom.js"></script>
...
<script src="<?php echo base_url() ?>assets/js/light.js" type="2d8d78e876b340f9029c575b-text/javascript"></script>
    ...
    <script>
        ...
        let nodeListMenu = document.querySelectorAll("li.pcoded-hasmenu");
        for (const elMenu of nodeListMenu) {
            ...
            let elSubmenuNodeList = elMenu.querySelectorAll(".submenu");
            let temu = null;
            for (const elSubmenu of elSubmenuNodeList) {

                // get link in submenu
                let link = elSubmenu.getAttribute("href");
                link = link.toLowerCase();
                if (link === path || path.includes(link)) {
                    temu = true;
                    elMenu.classList.add("active");
                    elMenu.classList.add("pcoded-trigger");
