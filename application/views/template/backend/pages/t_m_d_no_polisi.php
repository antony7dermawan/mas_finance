          ...
          <div class="">
            ...
            <div class="form-group">
              <label>Jenis Kendaraan</label>
                <select name="jenis_kendaraan_id" class='custom_width' id='select-state' placeholder='Pick a state...'>
                <?php
                foreach ($c_t_m_d_jenis_kendaraan as $key => $value) 
                {
                  echo "<option value='".$value->ID."'>".$value->JENIS_KENDARAAN."</option>";
            ...
            <div class="form-group">
              <label>No Unit</label>
              <input type='text' class='form-control' placeholder='Input Text' name='no_unit'>
            </div>
          ...
          <div class="">
            ...
            <div class="form-group">
              ...
              <div class="searchable">
                  <input type="text" name='jenis_kendaraan' placeholder="search" onkeyup="filterFunction(this,event)">
                  <ul>
                    <?php
                    foreach ($c_t_m_d_jenis_kendaraan as $key => $value) 
                    {
                      echo "<li>".$value->JENIS_KENDARAAN."</li>";
                    }
                    ?>
                  </ul>
              </div>
...
<script>
  ...
  [...elBtnEdits].forEach(edit => {
    edit.addEventListener("click", (e) => {
      ...
      elModalEdit.querySelector("[name=no_unit]").value = no_unit;
