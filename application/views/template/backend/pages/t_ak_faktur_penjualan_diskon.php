  ...
  <div class="card-block">
    ...
    <div class="table-responsive dt-responsive">
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          <?php
          foreach ($c_t_ak_faktur_penjualan_diskon as $key => $value) {
            echo "<tr>";
            echo "<td>" . ($key + 1) . "</td>";
            ...
            echo "<td>" . number_format(($value->VALUE_DISKON),2,'.',',') . "</td>";
            ...
            if($disabled=='')
            {
              echo "<a href='" . site_url('c_t_ak_faktur_penjualan_diskon/delete/'. $value->ID) . "/" . $faktur_penjualan_id ."/" . $pelanggan_id  . "' ";
