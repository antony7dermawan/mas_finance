<div class="card">
  <div class="card-header">
    <form action='<?php echo base_url("c_t_t_t_penjualan_jasa_3/date_penjualan_jasa_3"); ?>' class='no_voucer_area' method="post" id=''>
      <table>
        <tr>
          <th>
            Tanggal Transaksi:
          ...
          <th>
            <form action='/action_page.php'>
              <input type='date' class='form-control' name='date_penjualan_jasa_3' value='<?= $this->session->userdata('date_penjualan_jasa_3') ?>' onchange='this.form.submit();'>
          </th>
        </tr>
      </table>
  ...
  <div class="card-block">
    ...
    <div class="table-responsive dt-responsive">
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          <?php
          foreach ($c_t_t_t_penjualan_jasa_3 as $key => $value) {
            if($value->MARK_FOR_DELETE == 'f')
            {
              ...
              //satu button
              echo "<td>";
              echo "<a href='" . site_url('c_t_t_t_penjualan_jasa_rincian_3/index/' . $value->ID) . "' ";
              ...
              if ($value->SUM_SUB_TOTAL == 0) {
                ...
                echo "<a href='" . site_url('c_t_t_t_penjualan_jasa_3/delete/' . $value->ID) . "' ";
...
<form action="<?php echo base_url('c_t_t_t_penjualan_jasa_3/tambah') ?>" method="post" id='add_data'>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <fieldset class="form-group">
              ...
              <form action='/action_page.php'>
              <input type='date' class='form-control' name='date' value='<?= $this->session->userdata('date_penjualan_jasa_3') ?>'>
          </div> <!-- Membungkus Row !-->
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <fieldset class="form-group">
              ...
              <form action='/action_page.php'>
              <input type='date' class='form-control' name='date_kontrak' value='<?= $this->session->userdata('date_penjualan_jasa_3') ?>'>
          </div> <!-- Membungkus Row !-->
        </div>
...
<div class="modal fade" id="Modal_Edit" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <form action="<?php echo base_url('c_t_t_t_penjualan_jasa_3/edit_action') ?>" method="post" autocomplete="off" id='edit_data'>
      <div class="modal-content">
        <div class="modal-header">
...
<script>
  const read_data = <?= json_encode($c_t_t_t_penjualan_jasa_3) ?>;
