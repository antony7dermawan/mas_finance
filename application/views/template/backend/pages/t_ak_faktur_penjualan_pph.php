  ...
  <div class="card-block">
    ...
    <div class="table-responsive dt-responsive">
      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
          <?php
          foreach ($c_t_ak_faktur_penjualan_pph as $key => $value) {
            echo "<tr>";
            echo "<td>" . ($key + 1) . "</td>";
            ...
            if($disabled=='')
            {
              echo "<a href='" . site_url('c_t_ak_faktur_penjualan_pph/delete/'. $value->ID) . "/" . $faktur_penjualan_id ."/" . $pelanggan_id  . "' ";
...
<form action="<?php echo base_url('c_t_ak_faktur_penjualan_pph/tambah/'.$faktur_penjualan_id.'/'.$pelanggan_id) ?>" method="post" id='add_data'>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
              <label>Keterangan Diskon PPH</label>
              <textarea rows='4' cols='20' name='keterangan' id='' form='add_data' class='form-control'>Pot. PPH 23 (2%)</textarea>
          </div>
