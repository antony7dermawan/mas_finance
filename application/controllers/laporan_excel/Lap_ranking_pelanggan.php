<?php
      ...
      class Lap_ranking_pelanggan extends CI_Controller{
            ...
            public function index($date_from_laporan,$date_to_laporan,$barang_id,$kategori_id,$sales_id,$pelanggan_id,$supplier_id,$no_polisi_id,$anggota_id,$pemakai_id,$lokasi_id)
            {
                  ...
                  $data_logic = 0;
                  $key=0;
                  $read_select = $this->m_t_t_t_penjualan_rincian->select_rekap_pelanggan($date_from_laporan,$date_to_laporan);
                  ...
                  if($data_logic==1)
                  {
                    for($i=0;$i<=$total_data;$i++)
                    {
                              ...
                              $sheet->getStyle('A'.$row)->getAlignment()->setHorizontal('center');
                              $sheet->setCellValue('B'.$row, $r_pelanggan[$i]);
                              $sheet->getStyle('B'.$row)->getAlignment()->setHorizontal('center');
                  ...
                  $filename = 'lap_ranking_pelanggan';
