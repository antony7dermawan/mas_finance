...
class C_t_t_t_penjualan_jasa_3 extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $this->session->set_userdata('t_t_t_penjualan_jasa_3_delete_logic', '1');
    ...
    if($this->session->userdata('date_penjualan_jasa_3')=='')
    {
      $date_penjualan = date('Y-m-d');
      $this->session->set_userdata('date_penjualan_jasa_3', $date_penjualan_jasa_3);
    }
    $data = [
      "c_t_t_t_penjualan_jasa_3" => $this->m_t_t_t_penjualan_jasa_3->select($this->session->userdata('date_penjualan_jasa_3'),3),   //tipe kayu
      ...
      "title" => "Pendapatan Kayu/BBM",
      "description" => " "
    ];
    $this->render_backend('template/backend/pages/t_t_t_penjualan_jasa_3', $data);
  }


  public function date_penjualan_jasa_3()
  {
    $date_penjualan_jasa_3 = ($this->input->post("date_penjualan_jasa_3"));
    $this->session->set_userdata('date_penjualan_jasa_3', $date_penjualan_jasa_3);
    redirect('/c_t_t_t_penjualan_jasa_3');
  }
  ...
  public function delete($id)
  {
    ...
    $this->m_t_t_t_penjualan_jasa_3->update($data, $id);
  ...
  function tambah()
  {
    ...
    if($pelanggan_id!=0 and $payment_method_id!=0  )
    {
      ...
      $this->m_t_t_t_penjualan_jasa_3->tambah($data);
