...
class C_t_t_t_penjualan_jasa_1 extends MY_Controller
{
  ...
  public function index()
  {
    ...
    if($this->session->userdata('date_penjualan_jasa_1')=='')
    {
      $date_penjualan = date('Y-m-d');
      $this->session->set_userdata('date_penjualan_jasa_1', $date_penjualan_jasa_1);
    }
    $data = [
      "c_t_t_t_penjualan_jasa_1" => $this->m_t_t_t_penjualan_jasa_1->select($this->session->userdata('date_penjualan_jasa_1'),1),   //tipe cpo
    ...
    $this->render_backend('template/backend/pages/t_t_t_penjualan_jasa_1', $data);
  }


  public function date_penjualan_jasa_1()
  {
    $date_penjualan_jasa_1 = ($this->input->post("date_penjualan_jasa_1"));
    $this->session->set_userdata('date_penjualan_jasa_1', $date_penjualan_jasa_1);
    redirect('/c_t_t_t_penjualan_jasa_1');
  }
  ...
  public function delete($id)
  {
    ...
    $this->m_t_t_t_penjualan_jasa_1->update($data, $id);
