...
class C_t_m_d_petak extends MY_Controller
{
  ...
  {
    $this->session->set_userdata('t_m_d_petak_delete_logic', '1');
    $data = [
      "c_t_m_d_petak" => $this->m_t_m_d_petak->select(),
      "title" => "Master Petak",
      "description" => ""
    ];
    $this->render_backend('template/backend/pages/t_m_d_petak', $data);
  }
  ...
  public function delete($id)
  {
    ...
    $this->m_t_m_d_petak->update($data, $id);
    $this->session->set_flashdata('notif', '<div class="alert alert-danger icons-alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><i class="icofont icofont-close-line-circled"></i></button><p><strong>Success!</strong> Data Berhasil DIhapus!</p></div>');
    redirect('/c_t_m_d_petak');
  }
  ...
  function tambah()
  {
    ...
    $petak = substr($this->input->post("petak"), 0, 50);
    ...
    $this->m_t_m_d_petak->tambah($data);
